...
export class MTLFileLoader {
     ...
     * @param rootUrl
     */
    public parseMTL = function (scene: Scene, data: string, rootUrl: string) {
...
export class OBJFileLoader implements ISceneLoaderPlugin {
     ...
     * @private
     */
    private _parseSolid(meshesNames: any, scene: Scene, data: string, rootUrl: string): Array<AbstractMesh> {
